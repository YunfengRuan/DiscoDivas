`g1k_hm3_maf5_woamb_wolr.pca.weight` is the PC loadings (SNP effect size to generate the PC) used in the DiscoDivas paper. 
...
`generate.pca.plink.sh` is the script to generate individuals' PC based on `g1k_hm3_maf5_woamb_wolr.pca.weight` using plink2.
